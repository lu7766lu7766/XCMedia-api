...
class LiteratureNodeSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $group = $groupService->updateOrCreate(
            '成人文學-文學管理',
            ManageLiteratureNodeCodeConstants::MANAGE_LITERATURE
        );
        if ($group) {
            ...
            $nodeRead = $nodeService->edit(
                $group,
                '成人文學-文學管理-讀取',
                ManageLiteratureNodeCodeConstants::MANAGE_LITERATURE_READ
            );
            if ($nodeRead) {
            ...
            $nodeDel = $nodeService->edit(
                $group,
                '成人文學-文學管理-刪除',
                ManageLiteratureNodeCodeConstants::MANAGE_LITERATURE_DELETE
            );
            if ($nodeDel) {
