...
class UpdateLanguageSettingNodeSeederStep1 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $group = $groupService->updateOrCreate('影音电视-语言设定', LanguageSettingNodeCodeConstants::DRAMA_LANGUAGE_SETTING);
        if ($group) {
