...
class UpdateSourceSettingNodeSeederStep1 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $group = $groupService->updateOrCreate('影音电视-来源设定', SourceSettingNodeCodeConstants::DRAMA_SOURCE_SETTING);
        if ($group) {
