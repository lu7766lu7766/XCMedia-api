...
class LayoutNodeSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $group = $groupService->updateOrCreate('頁面管理', LayoutNodeCodeConstants::MANAGE_LAYOUT);
        if ($group) {
            ...
            $nodeRead = $nodeService->edit(
                $group,
                '頁面管理-讀取',
                LayoutNodeCodeConstants::MANAGE_LAYOUT_READ
            );
            if ($nodeRead) {
            ...
            $nodeDel = $nodeService->edit(
                $group,
                '頁面管理-刪除',
                LayoutNodeCodeConstants::MANAGE_LAYOUT_DELETE
            );
            if ($nodeDel) {
