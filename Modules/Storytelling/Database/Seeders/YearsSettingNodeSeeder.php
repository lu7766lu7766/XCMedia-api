...
class YearsSettingNodeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $group = $groupService->updateOrCreate('成人視頻-年份設定', YearsSettingNodeCodeConstants::STORYTELLING_YEARS_SETTING);
        if ($group) {
            ...
            $nodeRead = $nodeService->edit(
                $group,
                '成人視頻-年份設定-讀取',
                YearsSettingNodeCodeConstants::STORYTELLING_YEARS_SETTING_READ
            );
            if ($nodeRead) {
            ...
            $nodeCreate = $nodeService->edit(
                $group,
                '成人視頻-年份設定-新增',
                YearsSettingNodeCodeConstants::STORYTELLING_YEARS_SETTING_CREATE
            );
            if ($nodeCreate) {
            ...
            $nodeUpdate = $nodeService->edit(
                $group,
                '成人視頻-年份設定-編輯',
                YearsSettingNodeCodeConstants::STORYTELLING_YEARS_SETTING_UPDATE
            );
            if ($nodeUpdate) {
            ...
            $nodeDel = $nodeService->edit(
                $group,
                '成人視頻-年份設定-刪除',
                YearsSettingNodeCodeConstants::STORYTELLING_YEARS_SETTING_DELETE
            );
            if ($nodeDel) {
