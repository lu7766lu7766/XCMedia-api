...
class AVActressSettingNodeSeeder extends TreeNodeBindSeeder
{
    ...
    {
        return AVActressSettingNodeCodeConstants::PHOTOGRAPH_AV_ACTRESS_SETTING;
    }
    ...
    {
        return collect([
            AVActressSettingNodeCodeConstants::PHOTOGRAPH_AV_ACTRESS_SETTING_READ   => '成人寫真-女優設定-讀取',
            AVActressSettingNodeCodeConstants::PHOTOGRAPH_AV_ACTRESS_SETTING_CREATE => '成人寫真-女優設定-新增',
            AVActressSettingNodeCodeConstants::PHOTOGRAPH_AV_ACTRESS_SETTING_UPDATE => '成人寫真-女優設定-編輯',
            AVActressSettingNodeCodeConstants::PHOTOGRAPH_AV_ACTRESS_SETTING_DELETE => '成人寫真-女優設定-刪除',
        ]);
    }
}
