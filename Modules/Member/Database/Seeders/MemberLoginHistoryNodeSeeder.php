...
class MemberLoginHistoryNodeSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $group = $groupService->updateOrCreate('會員登入紀錄', NodeCodeConstants::MEMBER_LOGIN_HISTORY);
        if ($group) {
            ...
            $nodeRead = $nodeService->edit(
                $group,
                '會員登入紀錄-讀取',
                NodeCodeConstants::MEMBER_LOGIN_HISTORY_READ
            );
            if ($nodeRead) {
